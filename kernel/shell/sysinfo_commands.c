...
{
    print_text("=== AlderKernel Installer ===\n");
    ...
    install_placeholder_file(kernel_cl, "KERNEL", "ELF", "AlderKernel kernel.elf placeholder - no ELF loader yet.\n");
    ...
    install_placeholder_file(shell_cl, "ZSLASH", "ELF", "zSlash zslash.elf placeholder - no ELF loader yet.\n");
    ...
    install_placeholder_file(system_cl, "README", "TXT", "AlderKernel FAT16 disk - installed via 'install'.\n");
